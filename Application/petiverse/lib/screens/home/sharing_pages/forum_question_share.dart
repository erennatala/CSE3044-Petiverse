...
class ForumQuestionShare extends StatefulWidget {
  const ForumQuestionShare({Key? key}) : super(key: key);

  @override
  _ForumQuestionShareState createState() => _ForumQuestionShareState();
}

class _ForumQuestionShareState extends State<ForumQuestionShare> {
