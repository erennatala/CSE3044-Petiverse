...
class MatingProclomationShare extends StatefulWidget {
  const MatingProclomationShare({Key? key}) : super(key: key);

  @override
  _MatingProclomationShareState createState() =>
      _MatingProclomationShareState();
}

class _MatingProclomationShareState extends State<MatingProclomationShare> {
...
// user provided info for account creating page
  ...
  late MatingProclomationModel ad;

  @override
  void initState() {
    super.initState();
    ad = MatingProclomationModel(
        _title,
        _petsType,
        _petsAge,
        _ownerName,
