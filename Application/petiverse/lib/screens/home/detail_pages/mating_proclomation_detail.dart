...
class MatingProclomationDetailPage extends StatefulWidget {
  final selectedProclomation;
  const MatingProclomationDetailPage(
      {Key? key, required this.selectedProclomation})
      : super(key: key);

  @override
  _MatingProclomationDetailPageState createState() =>
      _MatingProclomationDetailPageState();
}

class _MatingProclomationDetailPageState
    extends State<MatingProclomationDetailPage> {
  @override
