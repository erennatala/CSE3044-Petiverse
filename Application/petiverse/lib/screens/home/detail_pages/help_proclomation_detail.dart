...
class HelpProclomationDetailPage extends StatefulWidget {
  final selectedProclomation;
  const HelpProclomationDetailPage(
      {Key? key, required this.selectedProclomation})
      : super(key: key);

  @override
  _HelpProclomationDetailPageState createState() =>
      _HelpProclomationDetailPageState();
}

class _HelpProclomationDetailPageState
    extends State<HelpProclomationDetailPage> {
  @override
